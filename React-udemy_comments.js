...
{/*    ====    19. Практика. Подъем состояния     ====
    ...
    //! Так как автор сделал оба метода через map то видно что отличие в них только в названии свойства вместо 
        ...
        //! currenTarget получаем значение аттрибута data-toggle. Используем currenTarget вместо обычного target чтобы игнорировать
    ...
    //todo Домашнее задание - сделать так чтобы нельзя было добавлять пустых сотрудников. Чтобы имя было не меньit 3 символов
