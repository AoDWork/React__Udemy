...
{/*    ====    06.  Практика с жизненным циклом, componentDidUpdate     ====
    ...
    Следующий этап развития приложения - по клику на карточку из списка - выводить информацию про нее справа от списка в компоненте
        ...
        для дальнейшего заполнения верстки не хватает информации о комиксах, если посмотрим на сайт с ответом про персонажа то
        можно увидеть там большой объект comics а в нем массив с объектами items. Нужно вытащить эти данные в service
